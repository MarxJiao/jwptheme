module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
        ...
        js: {
            src: ['js/functions.js', 'js/material.js', 'js/ripples.js','js/main.js'],
            dest: 'jwptheme/js/functions.js',
        }
    },
    ...
    copy: {
      ...
      theme: {
        ...
        cwd: "jwptheme/",
        src: "**",
        dest: "/Library/WebServer/Documents/wp-content/themes/jwptheme/",
        // flatten: true,
        filter: "isFile"
      }
    },
    ...
    less: {
      material: {
        options: {
          ...
          sourceMap: true,
          sourceMapRootpath: "/",
          sourceMapFilename: "css/bootstrap-material-design.css.map",
          sourceMapURL: "bootstrap-material-design.css.map"
        },
        files: {
          "css/bootstrap-material-design.css": "less/bootstrap-material-design.less",
        }
      },
      ripples: {
        options: {
          ...
          sourceMap: true,
          sourceMapRootpath: "/",
          sourceMapFilename: "css/ripples.css.map",
      ...
      bootstrap: {
        options: {
          ...
          sourceMap: true,
          outputSourceFiles: true,
          sourceMapURL: 'bower_components/bootstrap/dist/css/bootstrap.min.css.map',
          sourceMapFilename: 'bootstrap.min.css.map'
        },
      ...
      jwptheme: {
        options: {
          ...
          sourceMap: true,
          outputSourceFiles: true,
          sourceMapURL: 'css/jwptheme.css.map',
          sourceMapFilename: 'jwptheme.css.map'
        },
        src: 'less/jwptheme.less',
        dest: 'css/jwptheme.css'
      }
    },
    ...
    watch: {
      ...
      less: {
        files: ["bower_components/bootstrap/less/**/*.less","less/**/*.less","css/style.css"],
        tasks: ["less:bootstrap","less:material","less:jwptheme","concat:css","concat:js"]
      },
      js:{
        files: ["js/*.js"],
        tasks: ["concat:js"]
